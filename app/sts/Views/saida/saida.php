...
<main class="area_trabalho">
    <div class="area_formulario">
        <div class="area_botoes">
            <div class="btn">
                <button onclick="cadastrar()" class="personalizacao_btn">Cadastrar Saída</button>
            </div>
            <div class="btn">
                <button onclick="alterar()" class="personalizacao_btn">Alterar Saída</button>
            </div>
            <div class="btn">
                <button onclick="excluir()" class="personalizacao_btn">Excluir Saída</button>
            </div>
            <div class="btn">
                <button onclick="listar()" class="personalizacao_btn">Listar Saída</button>
            </div>
        </div>

        <div class="area_inputs">
            <div id="lista_inicial_area">
                <h1>Operações de Saída</h1>
            </div>
