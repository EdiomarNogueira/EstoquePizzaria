        ...
        <div id="area_inputs" class="area_inputs">
            ...
            <div id="cadastro" class="area_inputs">
                ...
                <form method="POST" action="" enctype="multipart/form-data">
                    <input name="id_estoque_entrada" type="hidden" class="" value=<?php echo $id_estoque_entrada ?>>
                    <h1 class="titulo_operacao">Alterar Entrada em Estoque</h1>
                    ...
                    <div>
                        ...
                        <div class="form_float">
                            <input class="input_pequeno" vtype="text" name="valor_unidade" placeholder=" " value="<?php echo $valor_unidade ?>">
